...
import { GET_ALL_GENRES, RESET_DETAIL, ORIGIN_FILTER } from "./actions";
...
const rootReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case GET_BY_DETAIL:
      return { ...state, detailGames: action.payload };
    ...
    case FILTER_BY_ORDER:
      ...
      return { ...state, videogames: orderedGames };
    ...
    case FILTER_BY_RATING:
      ...
      return { ...state, videogames: ratingGames };
